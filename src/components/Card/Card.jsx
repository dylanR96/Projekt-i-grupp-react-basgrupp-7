...
function Card({ card, getCardColorClass }) {
  const cardColorClass = getCardColorClass(); // Hämta klassnamnet för färgen
  return (
    <div className={`card ${cardColorClass}`}> {/* Lägg till cardColorClass */}
